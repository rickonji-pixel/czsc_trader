...
项目按研究、技术和使用三个领域维护长期入口：

| 领域 | 首要入口 | 主要内容 |
| --- | --- | --- |
| 策略研究 | [策略研究交接](research/README.md) | S001—S007批次目标与状态、研究工作流、数据污染和冻结规则 |
| 技术开发 | [技术交接](docs/DEVELOPMENT_HANDOFF.md) | 架构契约、代码入口、环境恢复、开发规则和测试边界 |
| 安装使用 | [用户使用说明](docs/USER_GUIDE.md) | 安装、数据、回测、决策、PTE控制台、服务启停和故障处理 |

### 专项与历史资料

| 使用场景 | 文档 | 主要内容 |
| --- | --- | --- |
| 在 macOS 上安装与启动 | [macOS安装与启动指南](docs/MACOS_GUIDE.md) | zsh命令对照、离线验证、PTE前台启动、平台差异与常见问题 |
...
继续策略研究时从策略研究交接进入；修改代码或运行测试时以技术交接为准。

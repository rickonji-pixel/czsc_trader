...
本文档记录截至 **2026-09-01 / 0901_EX20** 的可接力状态。0901_EX05—EX18已纳入`master`；0901_EX19—EX20在独立研究分支完成regime条件权重挑战及协议纠错，但尚未合并或推送。新会话仍应先验证仓库当前状态，不能把本文中的分支、提交或日期描述当成未经核验的实时事实。

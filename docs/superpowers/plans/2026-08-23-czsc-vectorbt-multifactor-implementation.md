...
Historical note: the first audited run missed 2026H1 and a later R03 added a Q1-performance-triggered full-long overlay. That overlay was subsequently ruled non-compliant because it was not generated by CZSC factors. The remediation plan in `2026-08-23-czsc-only-remediation.md` removes it completely; R03 must not be used as a compliant result.

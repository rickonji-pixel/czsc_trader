...
本文档记录截至 **2026-09-01 / 0901_EX04** 的可接力状态。0901_EX01—EX04在独立研究分支完成，尚未合并或推送；新会话应先验证仓库当前状态，不能把本文中的分支、提交或日期描述当成未经核验的实时事实。
...
研究链条可以概括为：0824_EX01—EX04建立并冻结EX04；0824_EX05—EX08扩大因子和搜索规模但未产生更优方案；0825_EX01对EX08候选补测仍全部失败；0825_EX02—EX06完成机制、路径、离场和新表示诊断；0826_EX01未找到跨年稳定的偏离边界；0829_EX01—0830_EX08证明冻结冠军路径后的简单仓位覆盖层不能同时保持收益并改善回撤；0901_EX01回到CZSC信息源并得到两个形式候选，但0901_EX02—EX04进一步证明力度层级、状态年龄和相对冠军已有笔方向的增量效果都不稳定。当前没有新因子足以进入统一仓位策略。

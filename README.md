...
- Regime权重结论：EX20删除EX19无依据的年度3/5否决门槛，在同一625项中冻结研究胜者143；其锁定2026卡玛、盈亏比、收益率和夏普率更高，但最大回撤与基线相同，正式FAIL，活动基线不变；
- 六候选诊断：EX21对EX20全部6个研究合格候选执行2026Q1、H1、M1—M8九项评分；125、143、275、293均为8.0分并列第一，418为4.5分，400为2.5分；这是已见2026诊断排名，不自动晋升策略；
- 证据边界：截至2026-08-31的行情均已被观察，新的未观察前向行情从该日期之后开始。
...
`0901_EX19`错误地增加了用户未授权的年度3/5否决门槛，因此其FAIL只保留为原始实验事实，不再用来终止路线。`0901_EX20`保持同一研究对象、625项空间和数据边界，改为只按连续2021—2025的最大回撤、卡玛和盈亏比共同改善筛选，冻结候选143后执行一次2026测试。挑战者收益率72.4634%、卡玛11.3525、盈亏比19.6580、夏普3.2295均高于基线，但最大回撤与基线同为-12.0868%，未满足三指标全部严格改善，正式FAIL；活动基线不变。

`0901_EX21`进一步固定EX20全部6个研究合格候选，在2026Q1、H1、M1—M8按最大回撤、卡玛和盈亏比逐格计分。125、143、275、293均以7胜2平0负获得8.0分并列第一；418得4.5分，与活动基线基准分相同；400得2.5分。这只是已见历史诊断排名，不构成独立样本外证据或自动晋升条件。

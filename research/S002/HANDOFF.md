...
- 候选资格：技术运行链路已经打通；SE已建议冻结，等待人工确认，尚无PTE部署资格；
- 研究数据：`2019-10-08`至`2026-09-08`；
- 当前开发截止：`2026-09-08`；
- 最近实验：`experiments/20260910_S002_EX15`。
...
100.00%、92.15%。SE输出`RECOMMEND_FREEZE / MIXED`：候选取得冻结人工评审资格，
...
下一步由用户评审EX15的冻结建议。若人工确认，再创建`S002-v1`和PTE虚拟账户；若不确认，
候选保持研究状态。继续保持固定五日规则，不围绕既有结果追加过滤器或动态持有期。

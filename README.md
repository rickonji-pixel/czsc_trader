...
- 最新正式研究档案：`0901_EX19`，当前共有44个Git跟踪实验档案；
...
- Regime权重结论：ER60中位数划分的单边趋势/箱体震荡两档组权重中，625项有6项连续窗口同时改善回撤、卡玛和盈亏比，但没有一项达到至少3/5年度双指标改善；EX19未冻结挑战者、未访问2026；
...
`0901_EX19`进一步检验了固定因子和阈值下的两档regime条件权重。研究集625项候选中113项改善最大回撤、132项改善卡玛、98项改善盈亏比，6项在连续2021—2025同时改善三项，但年度双指标改善最多只有2/5，未达到预注册的3/5门槛；因此没有冻结挑战者，也没有读取2026。该结果只否定本轮ER60中位数和组乘数网格，不否定所有regime表达。

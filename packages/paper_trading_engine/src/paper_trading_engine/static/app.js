...
const statusLabel = value => ({READY:'就绪',RUNNING:'运行中',OK:'正常',BLOCKED:'阻塞',UNAVAILABLE:'不可用',CHANNEL_UNAVAILABLE:'Futu不可用',CHANNEL_RECONCILIATION_BLOCKED:'渠道对账阻塞',VIRTUAL_ACCOUNT_BLOCKED:'虚拟账户阻塞',ORDER_SUBMISSION_UNRESOLVED:'存在下单结果待确认',DATA_PUBLICATION_FAILED:'发布数据失败',PENDING_SUBMIT:'待提交',SUBMITTING:'提交中',SUBMISSION_UNCERTAIN:'提交结果待确认',SUBMISSION_FAILED:'提交失败',REJECTED:'已拒绝',EXPIRED:'已过期',SUBMITTED:'已提交',FILLED_PART:'部分成交',FILLED_ALL:'全部成交',SUBMIT_FAILED:'提交失败',CANCELLED_ALL:'已撤销',PENDING:'待执行'}[value]||value||'—');

...
const statusLabel = value => ({READY:'就绪',RUNNING:'运行中',OK:'正常',BLOCKED:'阻塞',UNAVAILABLE:'不可用',DEGRADED_QUOTE:'行情降级',CHANNEL_RECONCILIATION_BLOCKED:'渠道对账阻塞',SUBMITTED:'已提交',SUBMITTING:'提交中',FILLED_PART:'部分成交',FILLED_ALL:'全部成交',CANCELLED_ALL:'已撤销',PENDING:'待执行'}[value]||value||'—');
